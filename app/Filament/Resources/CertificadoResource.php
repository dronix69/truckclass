                                    ...
                                    ->afterStateUpdated(function ($state, Forms\Set $set) {
                                        if ($state) {
                                            ...
                                            if ($curso) {
                                                ...
                                                $set('tipo', $curso->tipo);
                                                $set('fecha_start', $curso->fecha_start);
                                                $set('fecha_end', $curso->fecha_end);
                                            }
                                        }
                                    }),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('tipo')
                ...
                ->sortable()
                ->searchable(),
            Tables\Columns\TextColumn::make('fecha_start')
                ->label('Fecha de Inicio')
                ->date()
                ->sortable(),
            Tables\Columns\TextColumn::make('fecha_end')
                ->label('Fceha de Termino')
                ->date()
                ->sortable()
                ->searchable(),
            ...
            ->actions([
                ...
                // Boton para imprimir certificado del alumno
