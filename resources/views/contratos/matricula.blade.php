...
<body class="body">
    <section>
        ...
        <p class="lc">Entre La Escuela de Conductores CERCA, Rut 76.018.710-0, en adelante la empresa y el alumno
        </p>
        ...
        <p class="lc">Quien declara que estos datos son fidedignos, tienen a bien acordar el siguiente contrato de
            capacitación</p>
        ...
        <p class="le">1. Facilitar Gabinete Psicotécnico en horarios de lunes a viernes de 10 a 19 hrs.<br>
            2. Los contenidos del curso se ajustan a las disposiciones del Ministerio de Transportes, contenidos en el
            Decreto 122, promulgada el 09 de julio de 2012.<br>3. La Empresa asegura la confidencialidad de los datos
            del
            cliente, especialmente en lo que dice relación con el Examen Psicológico al que se debe someter el
            postulante<br>
            4. Emitir el Certificado de Casa Moneda al término total del curso, cuando el alumno haya aprobado todos sus
            módulos.<br>
            5. La Empresa facilitará el Bus y/o el Camión con remolque a aquellos alumnos que deben rendir sus exámenes
            de
            Práctica de Conducción ante las Direcciones de Tránsito de Temuco o de Padre Las Casas.<br>
            6. En caso que el alumno repruebe el Examen Teórico ante la Dirección de Tránsito, tendrá derecho a repetir
            aquellos módulos que significaron la reprobación, sin costos adicionales.<br>
            7. La Empresa realizará el Curso conducente a la obtención de la Licencia de Conductor Profesional Clase A3
            y/o
            A5, bajo las siguientes características</p>
        <table class="modulo">
            <tbody>
                <tr>
                    <th>MODULOS</th>
                ...
                <tr>
                    ...
                    <td class="yellow-background">Principios Físicos que intervienen en el Movimiento de los Vehículos
                    </td>
                ...
                <tr>
                    ...
                    <td class="yellow-background">Técnicas, destrezas y habilidades necesarias para la conducción según
                        el
                        tipo de vehículo</td>
                ...
                <tr>
                    ...
                    <td class="green-background">Procedimientos y normativa vigente específica aplicable al transporte
                        de
                        pasajeros.</td>
                ...
                <tr>
                    ...
                    <td class="rosybrown-background">Procedimientos y normativa vigente específica al sector transporte
                        de
                        carga.</td>
                ...
                <tr>
                    ...
                    <td class="rosybrown-background">Trámites y procedimientos asociados al transporte internacional e
                        intermodal.</td>
        ...
        <p class="lc"><b>Acerca de las Prácticas de Conducción:</b> Se agendarán una vez que el alumno finalice el
            Plan
            Común. Estas prácticas se dividen en 2 partes y se realizan por cada licencia a la que postule:<br>
            <b>Práctica
                en Simulador de Inmersión Total:</b> se realizarán 10 sesiones de 30 minutos cada una en grupos de 2 a 3
            personas.<br>
            <b>Práctica de Conducción en Bus:</b> se realizarán 6 clases de 60 minutos en minibús para 12 pasajeros y 6
            clases de 60 minutos en Bus para 28 pasajeros.<br>
            <b>Práctica de Conducción en Camión Articulado:</b> se realizarán 6 prácticas de 60 minutos en camión solo y
            6
            prácticas de conducción en Camión con remolque.<br>
            <b>Importante: Las clases prácticas agendadas pueden estar sujetas a cambios según disposición de la
                Escuela</b>
        </p>

        <p class="ld">OBLIGACIONES DEL ALUMNO(A)</p>

        <p class="lf">1. El Alumno declara que cumple con los siguientes requisitos para la realización del
            curso:<br>
        </p>
        <ol> a Tener como mínimo 20 años de edad</ol>
        ...
        4. El alumno deberá cancelar la totalidad del valor del curso para que se entregue el correspondiente
        Certificado
        Casa de Moneda que le permite iniciar su trámite de obtención de Licencia, ante la Dirección de Tránsito
        respectiva.<br><br>
        <b>LA POSTERGACIÓN Y/O ANULACIÓN DEL CURSO:</b> sólo se podrá realizar con 48 horas de anticipación a la fecha
        de
        inicio del curso y se descontará un <b>35% del valor total del curso,</b> por lo que una vez vencido el plazo no
        se
        podrá anular el curso. <br><br>
        Ambas partes declaran conocer en toda su extensión este contrato y aceptado los términos y condiciones del
        contrato
        de Capacitación de CERCA Ltda.<p></p>
    ...
    <section>
        ...
        <p class="ld">Nombre: {{ $matricula->nombre }} {{ $matricula->apellido }}</p>
        <p class="ld">Rut: {{ $matricula->rut }} &nbsp;&nbsp;&nbsp;&nbsp; Fecha: &nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;/
        </p><br>
    ...
    <section>
        ...
        <p class="ld">Nombre: {{ $matricula->nombre }} {{ $matricula->apellido }} &nbsp;&nbsp;&nbsp;&nbsp; Fecha:
    ...
    <section>
        ...
        <p class="ld">Nombre: {{ $matricula->nombre }} {{ $matricula->apellido }} &nbsp;&nbsp;&nbsp;&nbsp; Rut:
            {{ $matricula->rut }}</p>
